...
result = ['USA', 'UK', 'One China', 'Japan', 'Eurozone', 'Other Surplus', 'Other Deficit']
...
# Reorder columns
df = df[["USA", "UK", "Eurozone", "One China", "Japan", "Other Surplus", "Other Deficit"]]
...
eur_percent = df.loc[2029, 'Eurozone'] / (df.loc[2029, 'Other Surplus'] + df.loc[2029, 'Eurozone'] + df.loc[2029, 'One China'] + df.loc[2029, 'Japan'])
chn_percent = df.loc[2029, 'One China'] / (df.loc[2029, 'Other Surplus'] + df.loc[2029, 'Eurozone'] + df.loc[2029, 'One China'] + df.loc[2029, 'Japan'])
jpn_percent = df.loc[2029, 'Japan'] / (df.loc[2029, 'Other Surplus'] + df.loc[2029, 'Eurozone'] + df.loc[2029, 'One China'] + df.loc[2029, 'Japan'])
...
handles = [
    ...
    mpatches.Patch(color=palette[3], label="One China", linewidth=2),
    mpatches.Patch(color=palette[4], label="Japan", linewidth=2),
