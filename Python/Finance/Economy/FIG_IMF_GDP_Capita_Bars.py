...
def update(year):
    ...
    plt.title(f'Global Distribution of GDP per Capita (Adjusted PPP) by Country', fontsize=16, fontweight='bold', pad=20)
    plt.xlabel('Cumulative Global Population (M)', fontsize=10, fontweight='bold')
    plt.ylabel('GDP per capita (PPP)', fontsize=10, fontweight='bold')
