...
# Title and labels
ax1.text(0, 1.1, 'Wealth Distribution in Spain', fontsize=13, fontweight='bold', ha='left', transform=ax1.transAxes)
...
ax1.set_yticks(np.arange(0, 1200001, step=100000))
...
ax1.axhline(y=1160000, color='black', linestyle='--', linewidth=0.5, zorder=4)
ax1.axhline(y=1140000, color='black', linestyle='--', linewidth=0.5, zorder=4)
ax1.add_patch(patches.Rectangle((0, 1140000), 105, 20000, linewidth=0, edgecolor='none', facecolor='white', zorder=3))
...
# Save it...
plt.savefig("C:/Users/guillem.maya/Downloads/FIG_WID_Spain_Wealth_Distribution.png", dpi=300, bbox_inches='tight') 
