...
# Create dataframe
data = {
    'start': [0.000001, 0.00001, 0.0001, 0.001, 0.01, 0.1, 1, 10, 100, 1000, 10000, 100000],
    'end': [0.00001, 0.0001, 0.001, 0.01, 0.1, 1, 10, 100, 1000, 10000, 100000, 1000000],
    'rows': [6157560, 11301126, 13022890, 11675160, 7950235, 3477394, 840367, 134351, 15678, 1966, 92, 4],
    'btc': [35.33, 475.92, 4940, 43057, 269543, 1073504, 2088168, 4299343, 4441325, 4635004, 2290923, 648734]
}
...
# Save it...
plt.savefig("C:/Users/guillem.maya/Downloads/FIG_BITINFO_Bitcoin_Wealth_Distribution.png", dpi=300, bbox_inches='tight') 
